...
./RayTracer --scene 13 --width 128 --height 128 --samples 2 --shader-type 2 --shadowrays 4 > FOX_AO.log
./RayTracer --scene 21 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > SPNZA_SH.log
./RayTracer --scene 19 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > CRNVL_SH.log
./RayTracer --scene 14 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > FRST_SH.log
./RayTracer --scene 13 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > FOX_SH.log
./RayTracer --scene 11 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > SPRNG_SH.log
./RayTracer --scene 14 --width 128 --height 128 --samples 2 --shader-type 2 --shadowrays 4 > FRST_AO.log
./RayTracer --scene 12 --width 128 --height 128 --samples 2 --shader-type 2 --shadowrays 4 > PARTY_AO.log
./RayTracer --scene 19 --width 128 --height 128 --samples 2 --shader-type 2 --shadowrays 4 > CRNVL_AO.log
./RayTracer --scene 11 --width 128 --height 128 --samples 2 --shader-type 2 --shadowrays 4 > SPRNG_AO.log
...
./RayTracer --scene 9 --width 128 --height 128 --samples 2 > CAR_PT.log
./RayTracer --scene 15 --width 128 --height 128 --samples 2 > LANDS_PT.log
./RayTracer --scene 12 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > PARTY_SH.log
./RayTracer --scene 20 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > SHIP_SH.log
./RayTracer --scene 9 --width 128 --height 128 --samples 2 --shader-type 1 --shadowrays 2 > CAR_SH.log
./RayTracer --scene 19 --width 128 --height 128 --samples 2 > CRNVL_PT.log
./RayTracer --scene 14 --width 128 --height 128 --samples 2 > FRST_PT.log
./RayTracer --scene 11 --width 128 --height 128 --samples 2 > SPRNG_PT.log
./RayTracer --scene 12 --width 128 --height 128 --samples 2 > PARTY_PT.log
./RayTracer --scene 18 --width 128 --height 128 --samples 2 > BUNNY_PT.log
