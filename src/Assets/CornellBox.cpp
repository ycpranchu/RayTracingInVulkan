	...
	std::vector<Material>& materials)
{
	...
	// Back white panel
	i = static_cast<uint32_t>(vertices.size());
	vertices.push_back(Vertex{ l1, vec3(0, 0, 1), vec2(0, 1), 0 });
	vertices.push_back(Vertex{ r1, vec3(0, 0, 1), vec2(1, 1), 0 });
	vertices.push_back(Vertex{ r2, vec3(0, 0, 1), vec2(1, 0), 0 });
	vertices.push_back(Vertex{ l2, vec3(0, 0, 1), vec2(0, 0), 0 });
	...
	vertices.push_back(Vertex{ vec3(x0, y1, z1), vec3(0, -1, 0), vec2(0, 1), 1 });
	vertices.push_back(Vertex{ vec3(x1, y1, z1), vec3(0, -1, 0), vec2(1, 1), 1 });
	vertices.push_back(Vertex{ vec3(x1, y1, z0), vec3(0, -1, 0), vec2(1, 0), 1 });
	vertices.push_back(Vertex{ vec3(x0, y1, z0), vec3(0, -1, 0), vec2(0, 0), 1 });
