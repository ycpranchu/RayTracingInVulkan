...
namespace Vulkan
{
	...
	FrameBuffer::FrameBuffer(const class ImageView &imageView, const class RenderPass &renderPass) : imageView_(imageView),
	...
	FrameBuffer::FrameBuffer(FrameBuffer &&other) noexcept : imageView_(other.imageView_),
