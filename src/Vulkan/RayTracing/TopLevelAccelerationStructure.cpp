...
namespace Vulkan::RayTracing
{
	...
	TopLevelAccelerationStructure::TopLevelAccelerationStructure(
		...
		const uint32_t instancesCount) : AccelerationStructure(deviceProcedures, rayTracingProperties),
	...
	TopLevelAccelerationStructure::TopLevelAccelerationStructure(TopLevelAccelerationStructure &&other) noexcept : AccelerationStructure(std::move(other)),
