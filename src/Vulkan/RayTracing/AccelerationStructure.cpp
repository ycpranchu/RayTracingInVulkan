...
namespace Vulkan::RayTracing
{
	...
	AccelerationStructure::AccelerationStructure(const class DeviceProcedures &deviceProcedures, const RayTracingProperties &rayTracingProperties) : deviceProcedures_(deviceProcedures),
	...
	AccelerationStructure::AccelerationStructure(AccelerationStructure &&other) noexcept : deviceProcedures_(other.deviceProcedures_),
																						   flags_(other.flags_),
